...
export interface FieldDefinition {
  key: string
  label: string
  type: 'string' | 'number' | 'boolean' | 'date' | 'datetime' | 'email' | 'phone' | 'text' | 'url' | 'password' | 'geolocation' | 'address' | 'richText' | 'file' | 'select' | 'multiselect' | 'reference' | 'color'
  required?: boolean
  ...
  additionalFields?: string[] // Additional fields to display in reference lookup
