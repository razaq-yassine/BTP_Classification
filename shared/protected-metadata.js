...
export const PROTECTED_TABLES_SET = new Set(PROTECTED_TABLES);
...
export const PROTECTED_COLUMNS_SET = new Set(PROTECTED_COLUMNS);
...
export const SYSTEM_FIELDS_SET = new Set(SYSTEM_FIELDS);
...
export const SYSTEM_COLUMNS_SET = new Set(SYSTEM_COLUMNS);
...
export const SYSTEM_OBJECTS_SET = new Set(SYSTEM_OBJECTS);
/** Tenant system objects - exist when tenant mode != none (org) or org_and_tenant (tenant) */
export const TENANT_SYSTEM_OBJECTS = ["organization", "tenant"];
export const TENANT_SYSTEM_OBJECTS_SET = new Set(TENANT_SYSTEM_OBJECTS);
...
export const SYSTEM_OBJECT_BASE_FIELDS = {
    user: new Set([
        "id",
        "username",
        "email",
...
//# sourceMappingURL=protected-metadata.js.map